            ...
            switch (msg.what) {
                ...
                case MESSAGE_READ:
                    ...
                    if(readMessage.length() >4) {
                        Long a = Long.parseLong(readMessage.substring(9, 11), 16);
                        Long b = Long.parseLong(readMessage.substring(12, 14), 16);
                        String ddd= ""+(a*256+b)/4;

                        messageList.add(new androidRecyclerView.Message(counter++, ddd, mConnectedDeviceName));
                    }
                    break;
